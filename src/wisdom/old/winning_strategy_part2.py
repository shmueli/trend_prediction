#random nodes - (tomorrow, day-after-tomorrow)
...
def execute():
    ...
    for min_in_degree in min_in_degrees:
        ...
        store_daily_returns_for_all_individuals(start, end, min_in_degree, 'random_daily_' + str(min_in_degree) + '_1')
        #'''
        ...
        store_daily_returns_for_all_individuals(start, end, min_in_degree, 'random_daily_' + str(min_in_degree) + '_2')
        #'''
        ...
        store_daily_returns_for_all_individuals(start, end, min_in_degree, 'random_daily_' + str(min_in_degree) + '_3')
        #'''
        ...
        store_daily_returns_for_all_individuals(start, end, min_in_degree, 'random_daily_' + str(min_in_degree) + '_4')
        #'''
